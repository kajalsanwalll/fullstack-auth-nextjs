        ...
        <div className="w-full max-w-lg rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 p-8 shadow-2xl text-white">
          ...
          <div className="mt-6 space-y-4">
            ...
            <button
              ...
              className="w-full rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 py-3 font-medium transition hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-purple-500/30"
            >
              Get User Info
            </button>
